...
#Adjusted for windows by Miro: Code needed to be adjusted to ensure Windows-style line endings (CRLF) 
...
INPUTFULE="E:/MeMoSLAP_Phase2/neuronav/$SUB/1.dcm"
OUTPUTDIRECTORY="E:/MeMoSLAP_Phase2/neuronav/$SUB/unenhanced_t1/sub-$SUB/"
