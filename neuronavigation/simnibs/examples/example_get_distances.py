...
from simnibs_memoslap_utils.utils import get_scalp_skull_thickness_for_subject
...
[Q1_scalp, med_scalp, Q3_scalp,
 Q1_bone, med_bone, Q3_bone] = get_scalp_skull_thickness_for_subject(subject_path,
                                                                     add_cerebellum=True,
                                                                     radius=20.)
